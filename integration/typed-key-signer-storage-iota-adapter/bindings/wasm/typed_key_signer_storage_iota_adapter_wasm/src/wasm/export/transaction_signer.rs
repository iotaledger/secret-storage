...
use typed_key_signer_storage_iota_adapter::IotaCompatibleSigner;
...
pub struct WasmIotaCompatibleSigner(pub(crate) IotaCompatibleSigner<WasmSignerTypedKeySignature>);
